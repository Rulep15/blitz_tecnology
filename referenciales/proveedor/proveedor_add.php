                                        ...
                                        <div class=row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-6 col-sm-6 col-xs-7">
                                                    <input class="form-control" type="text" name="vrazon" required=""
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-10 col-md-10 col-lg-10">
                                        <input type="number" class="form-control" name="vcodigo" required="" autofocus="" id="vpaisdescri"
                                               placeholder="Ingrese Cod Pais" min="0">
                                    </div>
                                </div>
