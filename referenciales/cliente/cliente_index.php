                                ...
                                <div class="box-body no-padding">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-xs-12">
                                                        ...
                                                        <div class="col-lg-12 col-md-12 col-xs-12">
                                                            <div class="input-group custom-search-form">
                                                                <input type="search" class="form-control" name="buscar" 
                                                                       placeholder="Buscar por codigo del cliente..." autofocus=""/>
                                            ...
                                            $cliente = consultas::get_datos("SELECT * FROM v_ref_cliente WHERE (id_cliente||TRIM(UPPER(nombres))) LIKE TRIM(UPPER('%" . $valor . "%')) ORDER BY id_cliente");
                                            if (!empty($cliente)) {
                                                ?>
                                                        ...
                                                        <tbody>
                                                            <?php foreach ($cliente AS $cli) { ?>
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center"> <?php echo $cli['nombres']; ?></td>
                                                                     <td class="text-center">   
                                                                        <a href="cliente_edit.php?vidcliente=<?php echo $cli['id_cliente']; ?>" 
                                                                           class="btn btn-warning btn-sm" role="button"
                                                                           data-title="Editar" rel="tooltip" data-placement="top">
                                                                            <span class="glyphicon glyphicon-edit"></span>
                                                                        </a>
                                                                        <a href="cliente_delete.php?vidcliente=<?php echo $cli['id_cliente']; ?>" 
