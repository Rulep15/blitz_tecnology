                                ...
                                <div class="box-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php $cc = consultas::get_datos("SELECT COALESCE(MAX(id_pedido),0)+1 AS ultimo FROM ventas_pedidos") ?>
                                            <div class="col-lg-6 col-sm-6 col-xs-7">
                                                <input class="form-control" type="text" name="vidpedido" readonly="" value="<?php echo $cc[0]['ultimo']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
