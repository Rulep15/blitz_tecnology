                            ...
                            <div class="box-body no-padding">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-xs-12">
                                        ...
                                        $pedidos = consultas::get_datos("SELECT * FROM v_ventas_pedido WHERE (id_pedido||TRIM(UPPER(nombres))) LIKE TRIM(UPPER('%" . $valor . "%')) ORDER BY id_pedido");
                                        if (!empty($pedidos)) {
                                        ?>
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($pedidos as $pc) { ?>
                                                            <tr>
                                                                ...
                                                                <td class="text-center"> <?php echo $pc['totalp']; ?></td>
                                                                ...
                                                                <td class="text-center">
                                                                    ...
                                                                    <?php if ($pc['estado'] == 'ACTIVO') { ?>
                                                                        <a href="pedidosv_edit.php?vidpedido=<?php echo $pc['id_pedido']; ?>" class="btn btn-warning btn-sm" role="button" data-title="Editar" rel="tooltip" data-placement="top">
                                                                            <span class="glyphicon glyphicon-edit"></span>
                                                                        </a>
                                                                    <?php } ?>

                                                                    <?php if ($pc['estado'] == 'ACTIVO' || $pc['estado'] == 'ANULADO' || $pc['estado'] == 'CONFIRMADO') { ?>
                                                                        <a href="pedidosv_detalle.php?vidpedido=<?php echo $pc['id_pedido']; ?>" class="btn btn-primary btn-sm" role="button" data-title="Detalle" rel="tooltip" data-placement="top">
                                                                    ...
                                                                    <?php if ($pc['estado'] == 'CONFIRMADO') { ?>
                                                                        <a href="pedidosv_anular.php?vidpedido=<?php echo $pc['id_pedido']; ?>" class="btn btn-danger btn-sm" role="button" data-title="Anular" rel="tooltip" data-placement="top">
                                                                            <span class="glyphicon glyphicon-ban-circle"></span>
                                                                        </a>
                                                                    <?php } ?>
                                                                    <?php if ($pc['estado'] == 'CONFIRMADO') { ?>
                                                                        <a href="pedidosv_print.php?vidpedido=<?php echo $pc['id_pedido']; ?>" class="btn btn-success btn-sm" role="button" data-title="Impresion" rel="tooltip" data-placement="top">
