                                                ...
                                                <div class="form-group">
                                                    <div class="col-lg-12 col-md-12 col-xs-12">
                                                        <div class="input-group custom-search-form">
                                                            <input type="search" class="form-control" name="buscar" placeholder="Buscar por codigo o nombre..." autofocus="" />
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    ...
                                                                    <?php if ($c['estado'] == 'ACTIVO' || $c['estado'] == 'ANULADO' || $c['estado'] == 'CONFIRMADO') { ?>
                                                                        <a href="ventas_detalle.php?vidventa=<?php echo $c['id_venta']; ?>" class="btn btn-primary btn-sm" role="button" data-title="Detalle" rel="tooltip" data-placement="top">
                                                                    ...
                                                                    ?>
                                                                            <!--?php if ($c['totalc'] > 0) { ?>-->
                                                                            <a href="ventas_confirmar.php?vidventa=<?php echo $c['id_venta']; ?>" class="btn btn-success btn-sm" role="button" data-title="Confirmar" rel="tooltip" data-placement="top">
                                                                    ...
                                                                    <?php if ($c['estado'] == 'CONFIRMADO') { ?>
                                                                        <a href="ventas_anular.php?vidventa=<?php echo $c['id_venta']; ?>" class="btn btn-danger btn-sm" role="button" data-title="Anular" rel="tooltip" data-placement="top">
                                                                            <span class="glyphicon glyphicon-ban-circle"></span>
                                                                        </a>
                                                                    <?php } ?>
                                                                    <?php if ($c['estado'] == 'CONFIRMADO') { ?>
                                                                        <a href="ventas_print.php?vidventa=<?php echo $c['id_venta']; ?>" class="btn btn-success btn-sm" role="button" data-title="Impresion" rel="tooltip" data-placement="top">
