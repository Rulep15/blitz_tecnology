                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8 col-sm-8 col-xs-9">
                                            <input class="form-control" id="vnick" type="text" name="vnick" required="" onkeypress="return soloLetras(event);" style="width: 100%;" onpaste="return soloLetras(event);" maxlength="30" />
                                        </div>
                                    </div>
                                    <!--CLAVE-->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8 col-sm-8 col-xs-9">
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-btn">
                                                    <button class="btn btn-primary btn-flat" type="button" data-toggle="modal" data-target="#registrar_empleado">
                                                        <i class="fa fa-plus"></i>
                                                    </button>
                                                </span>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8 col-sm-8 col-xs-9">
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-btn">
                                                    <button class="btn btn-primary btn-flat" type="button" data-toggle="modal" data-target="#registrar_grupo">
                                                        <i class="fa fa-plus"></i>
                                                    </button>
                                                </span>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8 col-sm-8 col-xs-9">
                                            <input class="form-control" type="file" name="vimagen" style="width: 100%;" required="" min="0" placeholder="Seleccione una imagen">
                                        </div>
                                    </div>
                                </div>
