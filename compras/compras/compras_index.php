                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    ...
                                                                    <?php if ($c['estado'] == 'ACTIVO' || $c['estado'] == 'ANULADO' || $c['estado'] == 'CONFIRMADO') { ?>
                                                                        <a href="compras_detalle.php?vidcompra=<?php echo $c['id_compra']; ?>" class="btn btn-primary btn-sm" role="button" data-title="Detalle" rel="tooltip" data-placement="top">
                                                                    ...
                                                                    ?>
                                                                            <!--?php if ($c['totalc'] > 0) { ?>-->
                                                                            <a href="compras_confirmar.php?vidcompra=<?php echo $c['id_compra']; ?>" class="btn btn-success btn-sm" role="button" data-title="Confirmar" rel="tooltip" data-placement="top">
                                                                    ...
                                                                    <?php if ($c['estado'] == 'CONFIRMADO') { ?>
                                                                        <a href="compras_anular.php?vidcompra=<?php echo $c['id_compra']; ?>" class="btn btn-danger btn-sm" role="button" data-title="Anular" rel="tooltip" data-placement="top">
                                                                            <span class="glyphicon glyphicon-ban-circle"></span>
                                                                        </a>
                                                                    <?php } ?>
                                                                    <?php if ($c['estado'] == 'CONFIRMADO') { ?>
                                                                        <a href="compras_print.php?vidcompra=<?php echo $c['id_compra']; ?>" class="btn btn-success btn-sm" role="button" data-title="Impresion" rel="tooltip" data-placement="top">
