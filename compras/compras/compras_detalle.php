                                                    ...
                                                    <?php foreach ($comprasdetalle as $cd) { ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <?php if ($c['estado'] == 'ACTIVO') { ?>
                                                                    <a onclick="quitar(<?php echo "'" . $cd['id_compra'] . "_" . $cd['pro_cod'] . "_" . $cd['id_depo'] . "'"; ?>);" class="btn btn-danger btn-sm" role="button" data-title="Quitar" rel="tooltip" data-placement="top" data-toggle="modal" data-target="#quitar">
                                                ...
                                                <div class="box-body" style="left: 1000px;">
                                                    ...
                                                    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-4">
                                                        ...
                                                        <div class="form-group" id="precio">
                                                            ...
                                                            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
                                                                <input type="text" name="vprecio" class="form-control" readonly="" placeholder="Precio del Articulo" style="width: 300px;">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
                                                                <input type="number" name="vsubtotal" class="form-control" readonly="" min="1000" value="0" style="width: 300px;" id="idsubtotal">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
<SCRIPT>
    function obtenerprecio() {
        ...
        if (parseInt($('#idproducto').val()) > 0) {
            $.ajax({
                type: "GET",
                url: "/blitz_tecnology/compras/compras/listar_precios.php?vidproducto=" + dat[0],
                cache: false,
                beforeSend: function() {
